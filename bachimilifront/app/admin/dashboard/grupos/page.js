...
export default function GruposPage() {
  ...
  const [formData, setFormData] = useState({
    nombreGrupo: "",
    periodo: "", // Agregamos el estado para el periodo
  });
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("/admin/dashboard/grupos", {
        method: "POST",
        headers: {
      ...
      <div className="p-4">
        <div className="bg-white p-4 rounded-lg shadow-md max-w-4xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <h2 className="text-2xl mb-4 text-gray-700">Grupos</h2>
            <div>
            ...
            {/* Agregamos el select para el periodo */}
            <div>
