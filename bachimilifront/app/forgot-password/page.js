  ...
  return (
    <div>
      ...
      <div className="bg-blue-500 py-2 px-6 flex items-center">
        ...
        <h1 className="text-white text-xl ml-4">Recuperar Contraseña</h1>
      </div>
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl w-full mt-8">
          <div className="mb-6">
            <p className="text-gray-600 text-sm">
              Ingresa tus datos personales para proceder con la recuperación de tu contraseña.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end space-x-2">
              <button
                type="submit"
                className="bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500"
              >
                Enviar solicitud
              </button>
            </div>
